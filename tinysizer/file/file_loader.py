...
def validate_and_load_files(bdf_file, op2_file=None):
    ...
    try:
        ...
        return bdf_data, bdf_data.is_loaded, "Files loaded successfully"
        
    except Exception as e:
        error_msg = f"Error loading BDF file: {str(e)}\n"
        print(error_msg)
        return bdf_data, bdf_data.is_loaded, error_msg
